...
par(mfrow=c(2,2))
with(G,{
    plot(G$Global_active_power, type="l", xlab="",ylab="Global Active Power", xaxt="n")
    axis(1, at=t, labels=N)
    
    plot(G$Voltage, type="l", xlab="datetime",ylab="Voltage", xaxt="n")
    axis(1, at=t, labels=N)
    ...
    plot(G$Global_reactive_power, type="l", xlab="datetime", xaxt="n")
    axis(1, at=t, labels=N)
